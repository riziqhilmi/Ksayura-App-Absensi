    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <form method="POST" action="{{ route('owner.shifts.update', $shift) }}" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="time" id="start_time" name="start_time" value="{{ old('start_time', date('H:i', strtotime($shift->start_time))) }}" required
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                                @error('start_time')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="time" id="end_time" name="end_time" value="{{ old('end_time', date('H:i', strtotime($shift->end_time))) }}" required
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                                @error('end_time')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="time" id="break_start" name="break_start" value="{{ old('break_start', $shift->break_start ? date('H:i', strtotime($shift->break_start)) : '') }}"
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                                @error('break_start')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="time" id="break_end" name="break_end" value="{{ old('break_end', $shift->break_end ? date('H:i', strtotime($shift->break_end)) : '') }}"
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                                @error('break_end')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="grace_period" name="grace_period" value="{{ old('grace_period', $shift->grace_period) }}" required
                                    min="0" max="60"
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required
                                    ...
                                    <option value="inactive" {{ old('status', $shift->status) == 'inactive' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                                @error('status')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3"
                            class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">{{ old('notes', $shift->notes) }}</textarea>
                        @error('notes')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
