                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="hire_date" name="hire_date" value="{{ old('hire_date', $employee->user->hire_date ? \Illuminate\Support\Carbon::parse($employee->user->hire_date)->format('Y-m-d') : '') }}"
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
                            @error('hire_date')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" id="daily_rate" name="daily_rate" value="{{ old('daily_rate', $employee->daily_rate) }}" required
        ...
        <div>
            ...
            <select id="status" name="status" required
                ...
                <option value="resigned" @selected(old('status', $employee->status) === 'resigned')>Resign</option>
            </select>
            @error('status')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
            @enderror
