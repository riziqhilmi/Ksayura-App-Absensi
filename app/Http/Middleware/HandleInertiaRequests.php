    ...
    private function navigation(Request $request): array
    {
        ...
        if ($user->isOwner()) {
            return [
                'items' => [
                    ...
                    ['label' => 'Rekap Harian', 'href' => route('owner.daily-recaps.index'), 'active' => $request->routeIs('owner.daily-recaps.*'), 'inertia' => true, 'badge' => null],
                    ['label' => 'QRIS', 'href' => route('owner.qris-transactions.index'), 'active' => $request->routeIs('owner.qris-transactions.*'), 'inertia' => true, 'badge' => null],
        ...
        return [
            'items' => [
                ...
                ['label' => 'QRIS', 'href' => route('employee.qris-transactions.index'), 'active' => $request->routeIs('employee.qris-transactions.*'), 'inertia' => true, 'badge' => null],
                ['label' => 'Pengeluaran', 'href' => route('employee.daily-recap-expenses.index'), 'active' => $request->routeIs('employee.daily-recap-expenses.*'), 'inertia' => true, 'badge' => null],
                ['label' => 'Rekap Harian', 'href' => route('employee.daily-recaps.index'), 'active' => $request->routeIs('employee.daily-recaps.*'), 'inertia' => true, 'badge' => null],
